...
const sh = {
  ...
  iconCircle: { width: "48px", height: "48px", borderRadius: "14px", background: "linear-gradient(135deg, #0f4c35, #1a7a54)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "22px", flexShrink: 0, boxShadow: "0 4px 12px rgba(15,76,53,0.25)" },
  title: { fontSize: "17px", fontWeight: "800", color: "#111827", margin: 0 },
...
function UrgencyBadge({ level }) {
  const map = {
    ...
    normal:   { bg: "#f0fdf4", color: "#16a34a", text: "✓ NORMAL" },
  };
...
// ── Macro tab data ────────────────────────────────────────────────────────────
const MACRO_TABS = [
  { key: "carbs",   label: "Carbs",   emoji: "🍞", color: "#f59e0b", light: "#fffbeb", photo: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80", alt: "Rice and grains" },
  { key: "protein", label: "Protein", emoji: "🥩", color: "#dc2626", light: "#fef2f2", photo: "https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=600&q=80", alt: "Grilled chicken" },
  { key: "fat",     label: "Fats",    emoji: "🥑", color: "#16a34a", light: "#f0fdf4", photo: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80", alt: "Avocado and nuts" },
];
...
const mt = {
  ...
  tab: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "5px", padding: "9px 6px", border: "1.5px solid #d1d5db", borderRadius: "10px 10px 0 0", background: "#f9fafb", fontSize: "13px", fontWeight: "700", color: "#6b7280", cursor: "pointer", transition: "all 0.15s" },
  ...
  voiceText: { fontSize: "13px", color: "#374151", lineHeight: 1.6, margin: 0, background: "#f9fafb", padding: "12px", borderRadius: "10px" },
  athleteText: { fontSize: "13px", color: "#166534", lineHeight: 1.6, margin: 0, background: "#f0fdf4", padding: "12px", borderRadius: "10px", fontStyle: "italic" },
  ...
  whyText: { fontSize: "12px", color: "#374151", margin: 0, lineHeight: 1.5 },
  ...
  statPillUnit: { fontSize: "10px", color: "#6b7280", fontWeight: "400" },
  foodLabel: { fontSize: "11px", fontWeight: "700", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: "8px" },
  ...
  foodText: { fontSize: "10px", color: "#374151", lineHeight: 1.3, fontWeight: "500" },
...
export default function Blueprint({ athlete, onAddSchedule }) {
  ...
  const eventColors = { rest: "#6b7280", practice: "#2563eb", game: "#dc2626", tournament: "#7c3aed", strength: "#d97706" };
  const eventBg    = { rest: "#f9fafb", practice: "#eff6ff", game: "#fef2f2", tournament: "#faf5ff", strength: "#fffbeb" };
...
const s = {
  ...
  spinner: { width: "40px", height: "40px", border: "3px solid #e5e7eb", borderTopColor: "#0f4c35", borderRadius: "50%", animation: "spin 0.8s linear infinite" },
  ...
  bannerText: { fontSize: "13px", color: "#a7f3d0", lineHeight: 1.6, margin: 0 },
  bannerBtn: { background: "#fff", color: "#0f4c35", border: "none", borderRadius: "10px", padding: "12px 20px", fontSize: "14px", fontWeight: "800", cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0 },
  ...
  heroBadge: { display: "inline-block", background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)", color: "#a7f3d0", fontSize: "11px", fontWeight: "700", letterSpacing: "0.07em", textTransform: "uppercase", padding: "4px 12px", borderRadius: "99px", marginBottom: "10px" },
  heroHeadline: { fontSize: "clamp(18px,3vw,24px)", fontWeight: "800", color: "#fff", margin: "0 0 8px", lineHeight: 1.2 },
  heroSub: { fontSize: "12px", color: "#a7f3d0", lineHeight: 1.6, margin: "0 0 12px", maxWidth: "480px" },
  ...
  bigNumber: { fontSize: "44px", fontWeight: "900", color: "#0f4c35", lineHeight: 1 },
  bigUnit: { fontSize: "14px", color: "#6b7280", fontWeight: "600", marginBottom: "4px" },
  formulaNote: { fontSize: "11px", color: "#9ca3af", fontStyle: "italic", margin: 0 },
  ...
  eventCalUnit: { fontSize: "11px", color: "#6b7280", marginBottom: "6px" },
  eventMacros: { display: "flex", flexDirection: "column", gap: "3px" },
  macroChip: { fontSize: "10px", color: "#374151", background: "rgba(0,0,0,0.06)", borderRadius: "4px", padding: "2px 5px" },
  ...
  whyLabel: { fontSize: "10px", fontWeight: "800", color: "#16a34a", textTransform: "uppercase", letterSpacing: "0.06em", display: "block", marginBottom: "4px" },
  whyText: { fontSize: "12px", color: "#15803d", margin: 0, lineHeight: 1.5 },

  // Context note
  contextNote: { fontSize: "12px", color: "#6b7280", background: "#f9fafb", padding: "8px 12px", borderRadius: "8px", marginTop: "10px", lineHeight: 1.5 },
  ...
  disclaimer: { fontSize: "10px", color: "#9ca3af", textAlign: "center", lineHeight: 1.6, padding: "0 8px" },
};
