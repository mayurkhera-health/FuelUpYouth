...
const bb = {
  ...
  btn: { background: "none", border: "none", color: "#0f4c35", fontSize: "15px", fontWeight: "700", cursor: "pointer", padding: "4px 0" },
...
const s = {
  ...
  avatar: { width: "52px", height: "52px", borderRadius: "50%", background: "#0f4c35", color: "#fff", fontSize: "18px", fontWeight: "800", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, letterSpacing: "0.5px" },
  identityName: { fontSize: "16px", fontWeight: "800", color: "#111827" },
  identityMeta: { fontSize: "13px", color: "#374151", marginTop: "2px" },
  identityParent: { fontSize: "12px", color: "#6b7280", marginTop: "2px" },

  sectionLabel: { fontSize: "11px", fontWeight: "700", color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "8px", marginTop: "8px" },
  ...
  rowBody: { flex: 1 },
  rowLabel: { fontSize: "14px", fontWeight: "700", color: "#111827", marginBottom: "2px" },
  rowDesc: { fontSize: "12px", color: "#6b7280", lineHeight: 1.4 },
  chevron: { fontSize: "20px", color: "#9ca3af", fontWeight: "300" },
  ...
  infoVal: { fontSize: "13px", fontWeight: "600", color: "#374151" },
  ...
  disclaimer: { fontSize: "11px", color: "#9ca3af", textAlign: "center", marginTop: "16px", lineHeight: 1.6 },
};
