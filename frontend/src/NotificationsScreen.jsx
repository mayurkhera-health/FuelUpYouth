...
const s = {
  ...
  savingLabel: { fontSize: "12px", color: "#8aa898" },
  ...
  mainCardLeft: { flex: 1 },
  mainCardTitle: { fontSize: "16px", fontWeight: "700", color: "#1b3a2a", marginBottom: "4px" },
  mainCardDesc: { fontSize: "13px", color: "#8aa898", lineHeight: 1.5 },
  deniedNote: { fontSize: "12px", color: "#dc2626", marginTop: "8px", lineHeight: 1.5 },
  enableBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "10px 20px", fontSize: "14px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  sectionTitle: { fontSize: "14px", fontWeight: "700", color: "#1b3a2a", marginBottom: "4px" },
  sectionDesc: { fontSize: "12px", color: "#8aa898", marginBottom: "16px" },
  ...
  reminderBody: { flex: 1 },
  reminderTitle: { fontSize: "14px", fontWeight: "600", color: "#1b3a2a", marginBottom: "2px" },
  reminderDesc: { fontSize: "12px", color: "#8aa898" },
  ...
  testLeft: { flex: 1 },
  testTitle: { fontSize: "14px", fontWeight: "700", color: "#2d6a4f", marginBottom: "2px" },
  testDesc: { fontSize: "12px", color: "#8aa898" },
  testBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "8px 18px", fontSize: "13px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },

  howCard: { background: "#f4f8f5", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "16px 20px", marginBottom: "16px" },
  howTitle: { fontSize: "13px", fontWeight: "700", color: "#4a6358", marginBottom: "12px" },
  howRow: { display: "flex", gap: "10px", marginBottom: "8px", alignItems: "flex-start" },
  howIcon: { fontSize: "16px", flexShrink: 0 },
  howText: { fontSize: "13px", color: "#8aa898", lineHeight: 1.5 },
