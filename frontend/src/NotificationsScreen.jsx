        ...
        {REMINDERS.map((r) => (
          <div key={r.key} style={s.reminderRow}>
            ...
            <label style={s.toggle}>
              ...
              <div style={{
                ...s.toggleTrack,
                background: (prefs[r.key] && subscribed) ? "#0f4c35" : "#d1d5db",
              }}>
                <div style={{
                  ...s.toggleThumb,
...
const s = {
  ...
  savingLabel: { fontSize: "12px", color: "#9ca3af" },
  warningBox: { background: "#fffbeb", border: "1.5px solid #fde68a", borderRadius: "10px", padding: "12px 16px", fontSize: "13px", color: "#92400e", marginBottom: "16px" },
  errorBox: { background: "#fef2f2", border: "1.5px solid #fecaca", borderRadius: "10px", padding: "12px 16px", fontSize: "13px", color: "#dc2626", marginBottom: "16px" },

  mainCard: { display: "flex", justifyContent: "space-between", alignItems: "center", background: "#f9fafb", border: "1.5px solid #e5e7eb", borderRadius: "14px", padding: "20px", marginBottom: "16px", gap: "16px" },
  mainCardLeft: { flex: 1 },
  mainCardTitle: { fontSize: "16px", fontWeight: "700", color: "#111827", marginBottom: "4px" },
  mainCardDesc: { fontSize: "13px", color: "#6b7280", lineHeight: 1.5 },
  deniedNote: { fontSize: "12px", color: "#dc2626", marginTop: "8px", lineHeight: 1.5 },
  enableBtn: { background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", padding: "10px 20px", fontSize: "14px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  disableBtn: { background: "transparent", color: "#dc2626", border: "1.5px solid #fecaca", borderRadius: "8px", padding: "10px 20px", fontSize: "14px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },

  section: { border: "1.5px solid #e5e7eb", borderRadius: "14px", padding: "18px 20px", marginBottom: "16px" },
  sectionTitle: { fontSize: "14px", fontWeight: "700", color: "#111827", marginBottom: "4px" },
  sectionDesc: { fontSize: "12px", color: "#9ca3af", marginBottom: "16px" },
  ...
  reminderBody: { flex: 1 },
  reminderTitle: { fontSize: "14px", fontWeight: "600", color: "#111827", marginBottom: "2px" },
  reminderDesc: { fontSize: "12px", color: "#6b7280" },
  ...
  testLeft: { flex: 1 },
  testTitle: { fontSize: "14px", fontWeight: "700", color: "#0f4c35", marginBottom: "2px" },
  testDesc: { fontSize: "12px", color: "#6b7280" },
  testBtn: { background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", padding: "8px 18px", fontSize: "13px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },

  howCard: { background: "#f9fafb", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "16px 20px", marginBottom: "16px" },
  howTitle: { fontSize: "13px", fontWeight: "700", color: "#374151", marginBottom: "12px" },
  howRow: { display: "flex", gap: "10px", marginBottom: "8px", alignItems: "flex-start" },
  howIcon: { fontSize: "16px", flexShrink: 0 },
  howText: { fontSize: "13px", color: "#6b7280", lineHeight: 1.5 },
