...
const g = {
  ...
  badge: { fontSize: "18px", fontWeight: "700" },
};
...
const s = {
  title: { fontSize: "20px", fontWeight: "700", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a", margin: "0 0 20px" },
  ...
  sectionTitle: { fontSize: "17px", fontWeight: "700", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a" },
  sectionDesc: { fontSize: "14px", color: "#4a6358", marginTop: "2px" },
  runBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "7px 16px", fontSize: "15px", fontWeight: "600", cursor: "pointer", whiteSpace: "nowrap" },
  error: { color: "#dc2626", fontSize: "15px", marginBottom: "8px" },
  message: { fontSize: "16px", color: "#4a6358", marginBottom: "12px" },
  list: { marginBottom: "12px" },
  listTitle: { fontSize: "13px", fontWeight: "700", color: "#4a6358", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "6px" },
  listItem: { fontSize: "15px", color: "#4a6358", marginBottom: "4px" },
  trafficRow: { display: "flex", flexWrap: "wrap", gap: "10px", marginBottom: "12px" },
  trafficItem: { display: "flex", alignItems: "center", gap: "6px" },
  trafficLabel: { fontSize: "15px", color: "#4a6358", fontWeight: "600" },
  alert: { background: "#fffbeb", border: "1.5px solid #fde68a", borderRadius: "8px", padding: "10px 14px", fontSize: "15px", color: "#92400e", marginBottom: "8px" },
  weeklyCard: { background: "#f4f8f5", borderRadius: "8px", padding: "14px" },
  weeklyText: { fontSize: "16px", color: "#4a6358", marginBottom: "12px" },
  weekLabel: { fontSize: "13px", color: "#4a6358", marginTop: "8px" },
  dateRow: { marginBottom: "12px" },
  dateLabel: { display: "block", fontSize: "14px", fontWeight: "600", color: "#4a6358", marginBottom: "4px" },
  dateInput: { padding: "7px 10px", border: "1.5px solid #d1d5db", borderRadius: "8px", fontSize: "15px", outline: "none" },
  tourneyCard: { background: "#f4f8f5", borderRadius: "8px", padding: "14px" },
  tourneyRow: { display: "flex", justifyContent: "space-between", fontSize: "15px", marginBottom: "8px" },
  tourneyLabel: { color: "#4a6358", fontWeight: "600" },
  tourneyVal: { color: "#1b3a2a", fontWeight: "700" },
  carbRow: { marginBottom: "8px" },
  carbDay: { display: "block", fontSize: "13px", fontWeight: "700", color: "#2d6a4f", textTransform: "uppercase", letterSpacing: "0.04em" },
  carbPlan: { fontSize: "15px", color: "#4a6358" },
  disclaimer: { fontSize: "13px", color: "#8aa898", marginTop: "12px" },
};
