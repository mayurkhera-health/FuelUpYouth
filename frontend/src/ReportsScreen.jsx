...
const g = {
  ...
  badge: { fontSize: "17px", fontWeight: "700" },
};
...
const s = {
  title: { fontSize: "19px", fontWeight: "700", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a", margin: "0 0 20px" },
  ...
  sectionTitle: { fontSize: "16px", fontWeight: "700", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a" },
