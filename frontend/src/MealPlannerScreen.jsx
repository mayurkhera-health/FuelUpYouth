...
const rp = {
  ...
  title: { fontSize: "20px", fontWeight: "700", color: "#2d6a4f" },
  close: { background: "none", border: "none", cursor: "pointer", color: "#4a6358", fontSize: "22px", padding: "2px 6px" },
  empty: { fontSize: "20px", color: "#4a6358", textAlign: "center", padding: "12px 0" },
  ...
  optName: { fontSize: "20px", fontWeight: "700", color: "#1b3a2a", marginBottom: "2px" },
  optMeta: { fontSize: "19px", color: "#4a6358" },
  tags: { display: "flex", gap: "4px", marginTop: "4px", flexWrap: "wrap" },
  tag: { background: "#f0fdf4", color: "#2d6a4f", fontSize: "18px", fontWeight: "600", padding: "1px 6px", borderRadius: "99px" },
};
...
const dh = {
  ...
  title:          { fontSize:"21px", fontWeight:"900", color:"#fff", marginBottom:"6px", lineHeight:"1.2", fontFamily:"'Nunito', sans-serif" },
...
const ts = {
  ...
  headerText:   { flex:1 },
  slotName:     { fontSize:"18px", fontWeight:"800", color:"#1b3a2a", lineHeight:"1.2", fontFamily:"'Nunito', sans-serif" },
  ...
  recipeName:   { fontSize:"17px", fontWeight:"700", color:"#1b3a2a", marginBottom:"2px", lineHeight:"1.4" },
  ...
  addBtn:       { width:"100%", padding:"9px 12px", background:"#f0fdf4", border:"1.5px solid #2d6a4f", borderRadius:"9px", color:"#2d6a4f", fontSize:"17px", fontWeight:"700", cursor:"pointer" },
  ...
  alertTitle:   { fontSize:"17px", fontWeight:"800", color:"#92400e" },
...
const s = {
  ...
  importBannerTitle: { fontSize:"20px", fontWeight:"700", color:"#fff", marginBottom:"3px" },
  importBannerSub:   { fontSize:"18px", color:"#b7e4c7", lineHeight:"1.6" },
  importBannerClose: { background:"rgba(255,255,255,0.15)", border:"none", color:"#fff", borderRadius:"50%", width:"28px", height:"28px", cursor:"pointer", fontSize:"18px", flexShrink:0 },
  ...
  subtitle:      { fontSize:"17px", color:"#4a6358", margin:"0 0 12px" },
  ...
  loadingMsg:    { textAlign:"center", color:"#4a6358", padding:"40px 0", fontSize:"19px" },
