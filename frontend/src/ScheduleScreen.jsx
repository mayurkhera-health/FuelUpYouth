...
const EVENT_COLORS = {
  ...
  tournament: { bg: "#9333ea", text: "#fff" },
  practice:   { bg: "#d97706", text: "#fff" },
  rest:       { bg: "#0f4c35", text: "#fff" },
};
...
const c = {
  ...
  navBtn: { background: "none", border: "1.5px solid #e5e7eb", borderRadius: "8px", width: "32px", height: "32px", fontSize: "18px", cursor: "pointer", color: "#374151", display: "flex", alignItems: "center", justifyContent: "center" },
  monthTitle: { fontSize: "16px", fontWeight: "700", color: "#111827" },
  grid: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: "2px", marginBottom: "12px" },
  dayHeader: { textAlign: "center", fontSize: "11px", fontWeight: "700", color: "#9ca3af", paddingBottom: "8px", textTransform: "uppercase" },
  cell: { minHeight: "72px", borderRadius: "8px", padding: "4px", cursor: "pointer", border: "1.5px solid transparent", background: "#f9fafb" },
  cellToday: { background: "#f0fdf4", border: "1.5px solid #bbf7d0" },
  cellSelected: { border: "1.5px solid #0f4c35" },
  dayNum: { fontSize: "12px", fontWeight: "600", color: "#6b7280", marginBottom: "3px", textAlign: "right", paddingRight: "2px" },
  dayNumToday: { color: "#0f4c35", fontWeight: "800" },
  ...
  more: { fontSize: "10px", color: "#9ca3af", fontWeight: "600", paddingLeft: "4px" },
  legend: { display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "4px" },
  legendItem: { display: "flex", alignItems: "center", gap: "5px" },
  legendDot: { width: "10px", height: "10px", borderRadius: "3px" },
  legendLabel: { fontSize: "11px", color: "#6b7280", textTransform: "capitalize" },
};
...
const dp = {
  ...
  label: { fontSize: "14px", fontWeight: "700", color: "#111827" },
  close: { background: "none", border: "none", color: "#9ca3af", cursor: "pointer", fontSize: "16px" },
  empty: { fontSize: "13px", color: "#9ca3af", textAlign: "center", padding: "12px 0" },
  ...
  del: { background: "none", border: "none", color: "#9ca3af", cursor: "pointer", fontSize: "14px" },
};
...
const s = {
  ...
  addBtn: { background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", padding: "7px 14px", fontSize: "13px", fontWeight: "600", cursor: "pointer" },
  cancelBtn: { background: "none", border: "1.5px solid #d1d5db", color: "#6b7280", borderRadius: "8px", padding: "6px 14px", fontSize: "13px", fontWeight: "600", cursor: "pointer" },
  importSuccess: { background: "#f0fdf4", border: "1.5px solid #bbf7d0", borderRadius: "10px", padding: "12px 16px", fontSize: "14px", fontWeight: "600", color: "#0f4c35", marginBottom: "16px" },

  form: { background: "#f9fafb", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "20px", marginBottom: "24px" },
  formTitle: { fontSize: "15px", fontWeight: "700", color: "#111827", marginBottom: "16px" },
  ...
  saveBtn: { width: "100%", padding: "10px", background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "700", cursor: "pointer", marginTop: "4px" },
  error: { color: "#dc2626", fontSize: "13px", margin: "8px 0" },

  uploadBox: { background: "#f9fafb", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "20px", marginBottom: "24px" },
  ...
  uploadInstructions: { fontSize: "13px", color: "#374151", marginBottom: "12px" },
  ...
  parseBtn: { padding: "9px 16px", background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", fontSize: "13px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  dropZoneActive: { borderColor: "#0f4c35", background: "#f0fdf4" },
  dropText: { fontSize: "13px", color: "#9ca3af", fontWeight: "600" },

  preview: { background: "#fff", border: "1.5px solid #e5e7eb", borderRadius: "10px", padding: "14px", marginTop: "12px" },
  previewTitle: { fontSize: "14px", fontWeight: "700", color: "#111827", marginBottom: "4px" },
  previewNote: { fontSize: "12px", color: "#6b7280", marginBottom: "10px" },
  ...
  previewBody: { flex: 1 },
  previewName: { fontSize: "13px", fontWeight: "700", color: "#111827" },
  previewMeta: { fontSize: "11px", color: "#6b7280", marginTop: "2px" },
  typeSelect: { padding: "4px 8px", border: "1.5px solid #d1d5db", borderRadius: "6px", fontSize: "12px", outline: "none", background: "#fff" },
  importBtn: { width: "100%", padding: "10px", background: "#0f4c35", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "700", cursor: "pointer", marginTop: "12px" },

  emptyState: { textAlign: "center", padding: "48px 20px" },
  emptyIcon: { fontSize: "40px", marginBottom: "12px" },
  emptyText: { fontSize: "14px", color: "#6b7280", maxWidth: "320px", margin: "0 auto" },
