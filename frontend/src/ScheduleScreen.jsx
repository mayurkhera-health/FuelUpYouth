...
const c = {
  ...
  navBtn: { background: "none", border: "1.5px solid #e5e7eb", borderRadius: "8px", width: "32px", height: "32px", fontSize: "17px", cursor: "pointer", color: "#4a6358", display: "flex", alignItems: "center", justifyContent: "center" },
  ...
  dayHeader: { textAlign: "center", fontSize: "12px", fontWeight: "700", color: "#4a6358", paddingBottom: "8px", textTransform: "uppercase" },
  ...
  dayNum: { fontSize: "13px", fontWeight: "600", color: "#4a6358", marginBottom: "3px", textAlign: "right", paddingRight: "2px" },
  ...
  more: { fontSize: "12px", color: "#4a6358", fontWeight: "600", paddingLeft: "4px" },
  legend: { display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "4px" },
  legendItem: { display: "flex", alignItems: "center", gap: "5px" },
  legendDot: { width: "10px", height: "10px", borderRadius: "3px" },
  legendLabel: { fontSize: "12px", color: "#4a6358", textTransform: "capitalize" },
};
...
const dp = {
  ...
  close: { background: "none", border: "none", color: "#4a6358", cursor: "pointer", fontSize: "16px" },
  ...
  meta: { fontSize: "13px", color: "#4a6358", marginTop: "2px" },
  del: { background: "none", border: "none", color: "#4a6358", cursor: "pointer", fontSize: "14px" },
};
...
const s = {
  ...
  title: { fontSize: "17px", fontWeight: "700", color: "#1b3a2a", margin: 0 },
  addBtns: { display: "flex", gap: "8px" },
  addBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "7px 14px", fontSize: "14px", fontWeight: "600", cursor: "pointer" },
  cancelBtn: { background: "none", border: "1.5px solid #d1d5db", color: "#4a6358", borderRadius: "8px", padding: "6px 14px", fontSize: "14px", fontWeight: "600", cursor: "pointer" },
  ...
  field: { flex: 1 },
  label: { display: "block", fontSize: "13px", fontWeight: "600", color: "#4a6358", marginBottom: "4px" },
  ...
  error: { color: "#dc2626", fontSize: "14px", margin: "8px 0" },
  ...
  appChip: { fontSize: "12px", fontWeight: "600", padding: "3px 10px", background: "#e0f2fe", color: "#0369a1", borderRadius: "99px" },
  uploadInstructions: { fontSize: "14px", color: "#4a6358", marginBottom: "12px" },
  urlRow: { display: "flex", gap: "8px", marginBottom: "10px" },
  urlInput: { flex: 1, padding: "9px 12px", border: "1.5px solid #d1d5db", borderRadius: "8px", fontSize: "14px", outline: "none", fontFamily: "monospace" },
  parseBtn: { padding: "9px 16px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "14px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  dropText: { fontSize: "14px", color: "#4a6358", fontWeight: "600" },
  ...
  previewNote: { fontSize: "13px", color: "#4a6358", marginBottom: "10px" },
  ...
  previewBody: { flex: 1 },
  previewName: { fontSize: "14px", fontWeight: "700", color: "#1b3a2a" },
  previewMeta: { fontSize: "12px", color: "#4a6358", marginTop: "2px" },
  typeSelect: { padding: "4px 8px", border: "1.5px solid #d1d5db", borderRadius: "6px", fontSize: "13px", outline: "none", background: "#fff" },
  ...
  emptyText: { fontSize: "14px", color: "#4a6358", maxWidth: "320px", margin: "0 auto" },
