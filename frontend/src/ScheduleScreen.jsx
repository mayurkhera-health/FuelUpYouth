...
const c = {
  ...
  navBtn: { background: "none", border: "1.5px solid #e5e7eb", borderRadius: "8px", width: "32px", height: "32px", fontSize: "23px", cursor: "pointer", color: "#4a6358", display: "flex", alignItems: "center", justifyContent: "center" },
  monthTitle: { fontSize: "21px", fontWeight: "700", color: "#1b3a2a" },
  grid: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: "2px", marginBottom: "12px" },
  dayHeader: { textAlign: "center", fontSize: "16px", fontWeight: "700", color: "#4a6358", paddingBottom: "8px", textTransform: "uppercase" },
  ...
  dayNum: { fontSize: "17px", fontWeight: "600", color: "#4a6358", marginBottom: "3px", textAlign: "right", paddingRight: "2px" },
  dayNumToday: { color: "#2d6a4f", fontWeight: "800" },
  eventPills: { display: "flex", flexDirection: "column", gap: "2px" },
  pill: { fontSize: "15px", fontWeight: "600", padding: "1px 4px", borderRadius: "4px", lineHeight: "1.4", overflow: "hidden", whiteSpace: "nowrap" },
  more: { fontSize: "16px", color: "#4a6358", fontWeight: "600", paddingLeft: "4px" },
  legend: { display: "flex", gap: "12px", flexWrap: "wrap", marginTop: "4px" },
  legendItem: { display: "flex", alignItems: "center", gap: "5px" },
  legendDot: { width: "10px", height: "10px", borderRadius: "3px" },
  legendLabel: { fontSize: "16px", color: "#4a6358", textTransform: "capitalize" },
};
...
const dp = {
  ...
  label: { fontSize: "19px", fontWeight: "700", color: "#1b3a2a" },
  close: { background: "none", border: "none", color: "#4a6358", cursor: "pointer", fontSize: "21px" },
  empty: { fontSize: "18px", color: "#4a6358", textAlign: "center", padding: "12px 0" },
  row: { display: "flex", alignItems: "center", gap: "10px", padding: "10px 0", borderTop: "1px solid #f3f4f6" },
  typeBadge: { fontSize: "15px", fontWeight: "700", padding: "2px 8px", borderRadius: "99px", textTransform: "uppercase", whiteSpace: "nowrap" },
  body: { flex: 1 },
  name: { fontSize: "19px", fontWeight: "600", color: "#1b3a2a" },
  meta: { fontSize: "17px", color: "#4a6358", marginTop: "2px" },
  del: { background: "none", border: "none", color: "#4a6358", cursor: "pointer", fontSize: "19px" },
};
...
const s = {
  ...
  addBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "7px 14px", fontSize: "18px", fontWeight: "600", cursor: "pointer" },
  cancelBtn: { background: "none", border: "1.5px solid #d1d5db", color: "#4a6358", borderRadius: "8px", padding: "6px 14px", fontSize: "18px", fontWeight: "600", cursor: "pointer" },
  importSuccess: { background: "#f0fdf4", border: "1.5px solid #bbf7d0", borderRadius: "10px", padding: "12px 16px", fontSize: "19px", fontWeight: "600", color: "#2d6a4f", marginBottom: "16px" },

  form: { background: "#f4f8f5", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "20px", marginBottom: "24px" },
  formTitle: { fontSize: "20px", fontWeight: "700", color: "#1b3a2a", marginBottom: "16px" },
  row2: { display: "flex", gap: "12px", marginBottom: "12px" },
  row3: { display: "flex", gap: "12px", marginBottom: "12px" },
  field: { flex: 1 },
  label: { display: "block", fontSize: "17px", fontWeight: "600", color: "#4a6358", marginBottom: "4px" },
  input: { width: "100%", padding: "8px 10px", border: "1.5px solid #d1d5db", borderRadius: "8px", fontSize: "19px", boxSizing: "border-box", outline: "none", background: "#fff" },
  saveBtn: { width: "100%", padding: "10px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "19px", fontWeight: "700", cursor: "pointer", marginTop: "4px" },
  error: { color: "#dc2626", fontSize: "18px", margin: "8px 0" },
  ...
  appChip: { fontSize: "16px", fontWeight: "600", padding: "3px 10px", background: "#e0f2fe", color: "#0369a1", borderRadius: "99px" },
  uploadInstructions: { fontSize: "18px", color: "#4a6358", marginBottom: "12px" },
  urlRow: { display: "flex", gap: "8px", marginBottom: "10px" },
  urlInput: { flex: 1, padding: "9px 12px", border: "1.5px solid #d1d5db", borderRadius: "8px", fontSize: "18px", outline: "none", fontFamily: "monospace" },
  parseBtn: { padding: "9px 16px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "18px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  dropText: { fontSize: "18px", color: "#4a6358", fontWeight: "600" },

  preview: { background: "#fff", border: "1.5px solid #e5e7eb", borderRadius: "10px", padding: "14px", marginTop: "12px" },
  previewTitle: { fontSize: "19px", fontWeight: "700", color: "#1b3a2a", marginBottom: "4px" },
  previewNote: { fontSize: "17px", color: "#4a6358", marginBottom: "10px" },
  ...
  previewBody: { flex: 1 },
  previewName: { fontSize: "18px", fontWeight: "700", color: "#1b3a2a" },
  previewMeta: { fontSize: "16px", color: "#4a6358", marginTop: "2px" },
  typeSelect: { padding: "4px 8px", border: "1.5px solid #d1d5db", borderRadius: "6px", fontSize: "17px", outline: "none", background: "#fff" },
  importBtn: { width: "100%", padding: "10px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "19px", fontWeight: "700", cursor: "pointer", marginTop: "12px" },

  emptyState: { textAlign: "center", padding: "48px 20px" },
  emptyIcon: { fontSize: "43px", marginBottom: "12px" },
  emptyText: { fontSize: "19px", color: "#4a6358", maxWidth: "320px", margin: "0 auto" },
  empty: { textAlign: "center", color: "#4a6358", padding: "40px 0" },
};
