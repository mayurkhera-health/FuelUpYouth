...
const rb = {
  ...
  value: { fontSize: "18px", fontWeight: "800" },
...
const s = {
  ...
  athleteStatLabel: { fontSize: "13px", color: "#4a6358", marginTop: "2px" },
  athleteNote: { fontSize: "13px", color: "#4a6358", margin: 0 },
  ...
  eventChipType: { fontSize: "12px", fontWeight: "700", color: "#2d6a4f", textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: "3px" },
  eventChipName: { fontSize: "15px", fontWeight: "700", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a", marginBottom: "2px" },
  eventChipDate: { fontSize: "13px", color: "#4a6358" },
  ...
  sliderEnds: { display: "flex", justifyContent: "space-between", fontSize: "13px", color: "#4a6358", marginTop: "2px" },

  calcBtn: { width: "100%", padding: "13px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "10px", fontSize: "17px", fontWeight: "700", cursor: "pointer", marginBottom: "16px" },
  ...
  resultTitle: { fontSize: "18px", fontWeight: "800", fontFamily: "'Nunito', sans-serif", color: "#1b3a2a", marginBottom: "2px" },
  ...
  numberLabel: { fontSize: "13px", color: "#4a6358", marginTop: "4px" },
  ...
  timelineIcon: { fontSize: "20px", flexShrink: 0 },
  ...
  disclaimer: { fontSize: "13px", color: "#8aa898", textAlign: "center", marginTop: "8px", lineHeight: 1.6 },
};
