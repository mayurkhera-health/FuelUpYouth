...
const s = {
  ...
  loadText:   { fontSize: "17px", color: "#4a6358", fontFamily: "'DM Sans', sans-serif" },
  ...
  disclaimer: { textAlign: "center", fontSize: "14px", color: "#4a6358", lineHeight: "1.5", fontWeight: "400", padding: "10px 0 0" },
};
