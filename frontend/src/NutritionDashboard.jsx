...
function CalorieDial({ consumed, target }) {
  ...
  return (
    <div style={{ textAlign: "center", marginBottom: "12px" }}>
      ...
      <div style={{ fontSize: "17px", fontWeight: "700", color: stroke, marginTop: "2px" }}>
        {pctLabel}% — {statusText}
      </div>
    </div>
  );
...
const d = {
  ...
  label: { fontSize: "17px", fontWeight: "700", color: "#4a6358", marginTop: "4px" },
  range: { fontSize: "16px", color: "#4a6358", marginTop: "1px" },
};
...
const s = {
  ...
  dateLabel: { fontSize: "19px", color: "#4a6358", marginBottom: "12px" },
  dayBadge: { display: "inline-block", padding: "6px 14px", borderRadius: "99px", fontSize: "18px", fontWeight: "700", marginBottom: "20px" },
  section: { marginBottom: "24px" },
  sectionHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px" },
  sectionTitle: { fontSize: "19px", fontWeight: "700", color: "#1b3a2a", paddingBottom: "8px", borderBottom: "1.5px solid #e5e7eb", marginBottom: "12px" },
  ...
  microVal: { fontSize: "25px", fontWeight: "800", color: "#2d6a4f" },
  microLabel: { fontSize: "17px", color: "#4a6358", marginTop: "2px" },
  timingRow: { display: "flex", gap: "16px", marginBottom: "10px", padding: "10px 12px", background: "#f4f8f5", borderRadius: "8px" },
  timingTime: { fontSize: "17px", fontWeight: "700", color: "#2d6a4f", minWidth: "80px" },
  timingName: { fontSize: "18px", fontWeight: "600", color: "#1b3a2a" },
  timingDesc: { fontSize: "17px", color: "#4a6358", marginTop: "2px" },
  addBtn: { background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", padding: "6px 14px", fontSize: "18px", fontWeight: "600", cursor: "pointer" },
  logForm: { background: "#f4f8f5", border: "1.5px solid #e5e7eb", borderRadius: "12px", padding: "18px", marginBottom: "14px" },
  fieldLabel: { display: "block", fontSize: "17px", fontWeight: "700", color: "#4a6358", marginBottom: "7px", textTransform: "uppercase", letterSpacing: "0.05em" },
  descRow: { display: "flex", gap: "8px", alignItems: "center", marginBottom: "8px" },
  input: { width: "100%", padding: "9px 12px", border: "1.5px solid #d1d5db", borderRadius: "8px", fontSize: "19px", boxSizing: "border-box", marginBottom: "0", outline: "none" },
  lookupBtn: { flexShrink: 0, padding: "9px 14px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "18px", fontWeight: "700", cursor: "pointer", whiteSpace: "nowrap" },
  estimatingBanner: { fontSize: "17px", color: "#2d6a4f", fontWeight: "600", padding: "7px 10px", background: "#f0fdf4", border: "1.5px solid #bbf7d0", borderRadius: "7px", marginTop: "8px" },
  estimateBanner: { fontSize: "17px", padding: "7px 10px", border: "1.5px solid", borderRadius: "7px", marginTop: "8px", lineHeight: 1.5 },
  chipRow: { display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "4px" },
  chip: { padding: "6px 12px", background: "#fff", border: "1.5px solid #d1d5db", borderRadius: "99px", fontSize: "17px", fontWeight: "600", color: "#4a6358", cursor: "pointer" },
  ...
  macroSummaryTitle: { fontSize: "17px", fontWeight: "700", color: "#4a6358", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "10px", display: "flex", alignItems: "center", gap: "8px" },
  aiTag: { fontSize: "16px", fontWeight: "600", color: "#2d6a4f", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: "99px", padding: "1px 8px", textTransform: "none", letterSpacing: 0 },
  macroGrid: { display: "flex", gap: "8px", flexWrap: "wrap" },
  macroField: { flex: "1 1 80px" },
  unitLabel: { fontWeight: "400", color: "#4a6358" },
  inputLabel: { display: "block", fontSize: "16px", fontWeight: "600", color: "#4a6358", marginBottom: "3px" },
  smallInput: { width: "100%", padding: "7px 8px", border: "1.5px solid #d1d5db", borderRadius: "6px", fontSize: "18px", boxSizing: "border-box", outline: "none" },
  saveBtn: { width: "100%", padding: "10px", background: "linear-gradient(135deg, #2d6a4f, #52b788)", color: "#fff", border: "none", borderRadius: "8px", fontSize: "19px", fontWeight: "700", cursor: "pointer" },
  ...
  mealTag: { fontSize: "15px", fontWeight: "800", color: "#2d6a4f", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "2px" },
  mealDesc: { fontSize: "18px", fontWeight: "600", color: "#1b3a2a" },
  mealMacros: { fontSize: "16px", color: "#4a6358", marginTop: "2px" },
  deleteBtn: { background: "none", border: "none", color: "#4a6358", cursor: "pointer", fontSize: "19px" },
  empty: { fontSize: "19px", color: "#4a6358", textAlign: "center", padding: "16px 0" },
  errorTxt: { color: "#dc2626", fontSize: "18px", marginBottom: "8px" },
  analysisDesc: { fontSize: "17px", color: "#4a6358", marginTop: "2px" },
  ...
  scoreNum: { fontSize: "39px", fontWeight: "800", color: "#2d6a4f" },
  scoreLabel: { fontSize: "19px", color: "#4a6358" },
  suggestion: { fontSize: "18px", color: "#4a6358", marginBottom: "4px" },
  alertBox: { background: "#fffbeb", border: "1.5px solid #fde68a", borderRadius: "8px", padding: "8px 12px", fontSize: "18px", color: "#92400e", marginTop: "8px" },
