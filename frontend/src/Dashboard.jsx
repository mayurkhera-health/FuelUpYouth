...
const s = {
  ...
  desc: { fontSize: "14px", color: "#6b7280", marginBottom: "20px" },
  ...
  athleteName: { fontSize: "18px", fontWeight: "700", color: "#0f4c35", marginBottom: "4px" },
  athleteMeta: { fontSize: "14px", color: "#374151", marginBottom: "8px" },
  arrow: { fontSize: "13px", fontWeight: "600", color: "#0f4c35" },
  signOut: { width: "100%", padding: "12px", background: "transparent", color: "#0f4c35", border: "2px solid #0f4c35", borderRadius: "10px", fontSize: "15px", fontWeight: "600", cursor: "pointer", marginTop: "8px" },
};
