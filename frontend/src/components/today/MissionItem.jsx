export default function MissionItem({ item, isDone, onToggle }) {
  ...
  const boxStyle = {
    done:     { border: "1px solid rgba(45,106,79,.3)", background: "rgba(45,106,79,.12)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px", color: "#2d6a4f" },
...
const s = {
  ...
  body:      { flex: 1 },
  label:     { fontSize: "19px", fontWeight: "600", color: "#1b3a2a", lineHeight: "1.3", marginBottom: "3px" },
  labelDone: { textDecoration: "line-through", color: "#4a6358" },
  sub:       { fontSize: "17px", color: "#4a6358", fontWeight: "400", lineHeight: "1.4" },
  right:     { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "4px", flexShrink: 0 },
  time:      { fontSize: "16px", color: "#4a6358", fontWeight: "400" },
  tag:       { fontSize: "15px", fontWeight: "600", letterSpacing: ".04em", padding: "3px 8px", borderRadius: "3px" },
};
