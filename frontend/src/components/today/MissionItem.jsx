...
const s = {
  ...
  body:      { flex: 1 },
  label:     { fontSize: "15px", fontWeight: "600", color: "#1b3a2a", lineHeight: "1.3", marginBottom: "3px" },
  labelDone: { textDecoration: "line-through", color: "#4a6358" },
  sub:       { fontSize: "13px", color: "#4a6358", fontWeight: "400", lineHeight: "1.4" },
  ...
  tag:       { fontSize: "11px", fontWeight: "600", letterSpacing: ".04em", padding: "3px 8px", borderRadius: "3px" },
};
