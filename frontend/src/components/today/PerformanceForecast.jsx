...
const s = {
  ...
  eyebrow:    { fontSize: "16px", textTransform: "uppercase", letterSpacing: ".1em", color: "#4a6358" },
  right:      { fontSize: "16px", color: "#4a6358", fontWeight: "400" },
  grid:       { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" },
  itemHeader: { display: "flex", justifyContent: "space-between", marginBottom: "5px" },
  name:       { fontSize: "18px", color: "#1b3a2a" },
  pct:        { fontSize: "18px", fontWeight: "700" },
