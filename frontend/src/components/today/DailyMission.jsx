...
const s = {
  ...
  eyebrow:       { fontSize: "16px", textTransform: "uppercase", letterSpacing: ".1em", color: "#4a6358", marginBottom: "2px" },
  title:         { fontFamily: "'Nunito', sans-serif", fontSize: "23px", fontWeight: "800", letterSpacing: "-.02em", color: "#1b3a2a" },
  progress:      { textAlign: "right" },
  count:         { fontFamily: "'Nunito', sans-serif", fontSize: "29px", fontWeight: "800", letterSpacing: "-.04em", color: "#2d6a4f", lineHeight: "1" },
  denom:         { fontSize: "19px", color: "#4a6358", fontWeight: "400" },
  completeLabel: { fontSize: "16px", color: "#4a6358", fontWeight: "400", display: "block", marginBottom: "4px" },
