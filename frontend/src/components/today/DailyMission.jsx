...
const s = {
  ...
  eyebrow:       { fontSize: "11px", textTransform: "uppercase", letterSpacing: ".1em", color: "#4a6358", marginBottom: "2px" },
  title:         { fontFamily: "'Nunito', sans-serif", fontSize: "18px", fontWeight: "800", letterSpacing: "-.02em", color: "#1b3a2a" },
  progress:      { textAlign: "right" },
  count:         { fontFamily: "'Nunito', sans-serif", fontSize: "24px", fontWeight: "800", letterSpacing: "-.04em", color: "#2d6a4f", lineHeight: "1" },
