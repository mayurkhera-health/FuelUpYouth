...
const s = {
  ...
  eyebrow:       { fontSize: "19px", textTransform: "uppercase", letterSpacing: ".1em", color: "#4a6358", marginBottom: "2px" },
  title:         { fontFamily: "'Nunito', sans-serif", fontSize: "26px", fontWeight: "800", letterSpacing: "-.02em", color: "#1b3a2a" },
  progress:      { textAlign: "right" },
  count:         { fontFamily: "'Nunito', sans-serif", fontSize: "32px", fontWeight: "800", letterSpacing: "-.04em", color: "#2d6a4f", lineHeight: "1" },
  denom:         { fontSize: "22px", color: "#4a6358", fontWeight: "400" },
  completeLabel: { fontSize: "19px", color: "#4a6358", fontWeight: "400", display: "block", marginBottom: "4px" },
