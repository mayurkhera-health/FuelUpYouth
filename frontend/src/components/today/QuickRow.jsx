...
const s = {
  ...
  label:     { fontSize: "16px", textTransform: "uppercase", letterSpacing: ".07em", color: "#4a6358", marginBottom: "5px" },
  value:     { fontFamily: "'Nunito', sans-serif", fontSize: "31px", fontWeight: "800", letterSpacing: "-.03em", lineHeight: "1", marginBottom: "3px" },
  sub:       { fontSize: "17px", color: "#4a6358", fontWeight: "400", marginBottom: "7px" },
  ...
  note:      { fontSize: "17px", color: "#4a6358", fontWeight: "400", marginTop: "7px" },
};
