...
const s = {
  ...
  label:     { fontSize: "13px", textTransform: "uppercase", letterSpacing: ".07em", color: "#4a6358", marginBottom: "5px" },
  value:     { fontFamily: "'Nunito', sans-serif", fontSize: "28px", fontWeight: "800", letterSpacing: "-.03em", lineHeight: "1", marginBottom: "3px" },
  sub:       { fontSize: "14px", color: "#4a6358", fontWeight: "400", marginBottom: "7px" },
  cups:      { display: "flex", flexWrap: "wrap", gap: "4px", marginTop: "5px" },
  cup:       { width: "22px", height: "22px", borderRadius: "4px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", cursor: "pointer", border: "none", padding: 0 },
  ...
  note:      { fontSize: "14px", color: "#4a6358", fontWeight: "400", marginTop: "7px" },
};
