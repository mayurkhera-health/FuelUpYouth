...
const s = {
  ...
  label:     { fontSize: "12px", textTransform: "uppercase", letterSpacing: ".07em", color: "#4a6358", marginBottom: "5px" },
  value:     { fontFamily: "'Nunito', sans-serif", fontSize: "29px", fontWeight: "800", letterSpacing: "-.03em", lineHeight: "1", marginBottom: "3px" },
  sub:       { fontSize: "13px", color: "#4a6358", fontWeight: "400", marginBottom: "7px" },
  cups:      { display: "flex", flexWrap: "wrap", gap: "4px", marginTop: "5px" },
  cup:       { width: "22px", height: "22px", borderRadius: "4px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "15px", cursor: "pointer", border: "none", padding: 0 },
  ...
  note:      { fontSize: "13px", color: "#4a6358", fontWeight: "400", marginTop: "7px" },
};
