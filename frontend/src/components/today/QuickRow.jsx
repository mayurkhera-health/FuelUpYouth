...
const s = {
  ...
  label:     { fontSize: "19px", textTransform: "uppercase", letterSpacing: ".07em", color: "#4a6358", marginBottom: "5px" },
  value:     { fontFamily: "'Nunito', sans-serif", fontSize: "34px", fontWeight: "800", letterSpacing: "-.03em", lineHeight: "1", marginBottom: "3px" },
  sub:       { fontSize: "20px", color: "#4a6358", fontWeight: "400", marginBottom: "7px" },
  cups:      { display: "flex", flexWrap: "wrap", gap: "4px", marginTop: "5px" },
  cup:       { width: "22px", height: "22px", borderRadius: "4px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px", cursor: "pointer", border: "none", padding: 0 },
  ...
  note:      { fontSize: "20px", color: "#4a6358", fontWeight: "400", marginTop: "7px" },
};
