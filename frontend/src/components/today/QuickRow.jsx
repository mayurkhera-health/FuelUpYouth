...
const s = {
  ...
  label:     { fontSize: "11px", textTransform: "uppercase", letterSpacing: ".07em", color: "#4a6358", marginBottom: "4px" },
  value:     { fontFamily: "'Nunito', sans-serif", fontSize: "24px", fontWeight: "800", letterSpacing: "-.03em", lineHeight: "1", marginBottom: "2px" },
  sub:       { fontSize: "12px", color: "#4a6358", fontWeight: "400", marginBottom: "6px" },
  ...
  note:      { fontSize: "12px", color: "#4a6358", fontWeight: "400", marginTop: "6px" },
};
