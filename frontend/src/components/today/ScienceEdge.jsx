...
const s = {
  ...
  eyebrow:    { fontSize: "13px", fontWeight: "600", textTransform: "uppercase", letterSpacing: ".1em", color: "#2d6a4f", flex: 1 },
  ...
  body:       { padding: "14px" },
  quote:      { fontFamily: "'Nunito', sans-serif", fontSize: "19px", fontWeight: "700", letterSpacing: "-.01em", color: "#1b3a2a", lineHeight: "1.4", marginBottom: "10px" },
