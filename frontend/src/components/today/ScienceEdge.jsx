...
const s = {
  ...
  iconBox:    { width: "26px", height: "26px", borderRadius: "6px", background: "rgba(45,106,79,.10)", border: "1px solid rgba(45,106,79,.20)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "19px" },
  eyebrow:    { fontSize: "19px", fontWeight: "600", textTransform: "uppercase", letterSpacing: ".1em", color: "#2d6a4f", flex: 1 },
  ...
  body:       { padding: "14px" },
  quote:      { fontFamily: "'Nunito', sans-serif", fontSize: "25px", fontWeight: "700", letterSpacing: "-.01em", color: "#1b3a2a", lineHeight: "1.4", marginBottom: "10px" },
  detail:     { fontSize: "21px", color: "#4a6358", fontWeight: "400", lineHeight: "1.6", marginBottom: "12px" },
  ...
  fixName:    { fontSize: "21px", color: "#1b3a2a" },
  fixGain:    { fontSize: "20px", fontWeight: "700", color: "#2d6a4f" },
  source:     { marginTop: "10px", paddingTop: "10px", borderTop: "1px solid #dce8e0", fontSize: "19px", color: "#4a6358", fontWeight: "400" },
};
